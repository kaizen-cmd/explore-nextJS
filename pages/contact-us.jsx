                ...
                <div className="col-lg-full d-flex flex-column align-items-center mb-5">
                  <form method="post">
                    <div className=" text-center row-md-3 m-4">
                      <h4>Drop Us a Message, We would love to hear it from you</h4></div>           
                      <div className="row m-2 p-2 ">                                                               
                          <div className="col-md-6 m-2 p-2">                      
                              <div className="form-group p-2">
                                <input type="text" name="txtName" className="form-control text-center" placeholder="Name *"  />
                              </div>
                              <div className="form-group p-2">
                                <input type="text" name="txtEmail" className="form-control text-center" placeholder="Email *"  />
                              </div>
                              <div className="form-group p-2">
                          ...
                          <img src="images/contactus.svg" className="m-5 align-items-center"></img>
                      </div>
                  </form>   
                </div>
            </div>
